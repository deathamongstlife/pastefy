package de.interaapps.pastely.service;

import com.google.gson.Gson;
import de.interaapps.pastely.Pastely;
import de.interaapps.pastely.model.database.Webhook;
import de.interaapps.pastely.model.database.WebhookEvent;
...
public class WebhookService {
    ...
    public static void triggerWebhooks(String userId, String eventType, Map<String, Object> payload) {
        ...
        for (Webhook webhook : webhooks) {
            ...
            Pastely.getInstance().executeAsync(() -> dispatchWebhook(webhook, eventType, payload));
        }
    }
