package de.interaapps.pastely.helper.elastic;
...
public class ElasticMigrator {
    private final Pastely pastely;
    private ElasticsearchClient client;
    public ElasticMigrator(Pastely pastely, ElasticsearchClient client) {
        this.pastely = pastely;
        this.client = client;
    }
...

    {
        ...
        builders.put("pastely_pastes", pastes);
    }

    public void createIfNotExists(String index) throws IOException {
        if (!pastely.isIndexAvailable(index)) {
    ...
    public void migrateAll() throws IOException {
        for (String index : pastely.INDEXES) {
