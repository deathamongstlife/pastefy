package de.interaapps.pastely.model.minio;
...
public class MinioPaste extends AbstractObject {
    ...
    public String getBucket() {
        return get("bucket", AbstractElement.fromObject(Pastely.getInstance().getConfig().get("minio.bucket", "pastefy"))).string();
    }

    public String getServer() {
        return get("bucket", AbstractElement.fromObject(Pastely.getInstance().getConfig().get("server.bucket"))).string();
    }
    ...
    public static void store(Paste paste) {
        if (Pastely.getInstance().isMinioEnabled()) {
            ...
            try {
                ObjectWriteResponse objectWriteResponse = Pastely.getInstance().getMinioClient().putObject(
                ...
                String jsonString = new MinioPaste()
                        .setServer(Pastely.getInstance().getConfig().get("minio.server"))
                        .setBucket(objectWriteResponse.bucket())
                        .setObjectName(objectWriteResponse.object())
                        .setRegion(objectWriteResponse.region() == null ? Pastely.getInstance().getConfig().get("minio.region") : objectWriteResponse.region())
    ...
    public static void delete(Paste paste) {
        if (Pastely.getInstance().isMinioEnabled()) {
            try {
                ...
                Pastely.getInstance().getMinioClient().removeObject(RemoveObjectArgs.builder()
