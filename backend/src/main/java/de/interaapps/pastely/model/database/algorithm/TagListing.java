package de.interaapps.pastely.model.database.algorithm;
        ...
        if (tagListing == null) {
            ...
            if (Pastely.getInstance().aiEnabled()) {
                try {
                    ...
                    new Thread(() -> {
                        finalTagListing.description = Pastely.getInstance().getPasteAI().generateTagDescription(finalTagListing);
