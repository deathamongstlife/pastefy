package cc.allyapps.pastely.auth.strategies.oauth2.providers;
...
public class TwitchOAuth2Provider implements OAuth2Provider {
    ...
    public static class OAuth2Callback extends cc.allyapps.pastely.auth.strategies.oauth2.OAuth2Callback {
        private String clientId;
